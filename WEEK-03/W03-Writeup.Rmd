...
The pattern is a straight, diagonal line. It means that the z-scores are linearly transformed scores from the raw scores. The raw scores are within two standard deviations, and the points are roughly equidistant from each other.
